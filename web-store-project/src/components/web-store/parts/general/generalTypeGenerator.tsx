...
function GeneralTypeGenerator({ partType, addItemToCart, addFavourite }: { partType: typeof PartTypes[keyof typeof PartTypes], addItemToCart: (item: Part) => void, addFavourite: (item: Part) => void }) {
    if (partType) {
